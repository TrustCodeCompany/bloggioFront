          ...
          <div className="row">
            <div className="col-md-6 col-lg-3">
              <div className="blog-entry">
                <a href="single.html" className="img-link">
                  <img
                    src="./src/assets/images/img_1_horizontal.jpg"
                    alt="Image"
                    className="img-fluid"
                  />
                </a>
            ...
            <div className="col-md-6 col-lg-3">
              <div className="blog-entry">
                <a href="single.html" className="img-link">
                  <img
                    src="./src/assets/images/img_2_horizontal.jpg"
                    alt="Image"
                    className="img-fluid"
                  />
                </a>
            ...
            <div className="col-md-6 col-lg-3">
              <div className="blog-entry">
                <a href="single.html" className="img-link">
                  <img
                    src="./src/assets/images/img_3_horizontal.jpg"
                    alt="Image"
                    className="img-fluid"
                  />
                </a>
            ...
            <div className="col-md-6 col-lg-3">
              <div className="blog-entry">
                <a href="single.html" className="img-link">
                  <img
                    src="./src/assets/images/img_4_horizontal.jpg"
                    alt="Image"
                    className="img-fluid"
                  />
                </a>
          ...
          <div className="row">
            <div className="col-lg-4 mb-4">
              <div className="post-entry-alt">
                <a href="single.html" className="img-link">
                  <img
                    src="./src/assets/images/img_7_horizontal.jpg"
                    alt="Image"
                    className="img-fluid"
                  />
                </a>
            ...
            <div className="col-lg-4 mb-4">
              <div className="post-entry-alt">
                <a href="single.html" className="img-link">
                  <img
                    src="./src/assets/images/img_6_horizontal.jpg"
                    alt="Image"
                    className="img-fluid"
                  />
                </a>
            ...
            <div className="col-lg-4 mb-4">
              <div className="post-entry-alt">
                <a href="single.html" className="img-link">
                  <img
                    src="./src/assets/images/img_5_horizontal.jpg"
                    alt="Image"
                    className="img-fluid"
                  />
                </a>
            ...
            <div className="col-md-5 order-md-2">
              <a href="single.html" className="hentry img-1 h-100 gradient">
                <div
                  className="featured-img"
                  style={{
                    backgroundImage: `url('./src/assets/images/img_2_vertical.jpg')`,
                  }}></div>
                <div className="text">
            ...
            <div className="col-md-7">
              <a
                ...
                <div
                  className="featured-img"
                  style={{
                    backgroundImage: `url('./src/assets/images/img_1_horizontal.jpg')`,
                  }}></div>
              ...
              <div className="two-col d-block d-md-flex justify-content-between">
                <a
                  ...
                  <div
                    className="featured-img"
                    style={{
                      backgroundImage: `url('./src/assets/images/img_2_sq.jpg')`,
                    }}></div>
                  <div className="text text-sm">
                    <span>February 12, 2019</span>
                    <h2>Don’t assume your user data in the cloud is safe</h2>
                ...
                <a
                  ...
                  <div
                    className="featured-img"
                    style={{
                      backgroundImage: `url('./src/assets/images/img_3_sq.jpg')`,
                    }}></div>
                  <div className="text text-sm">
                    <span>February 12, 2019</span>
                    <h2>Startup vs corporate: What job suits you best?</h2>
